...
*/
int BASE64_DECLSPEC bin_to_b64_nopad(const uint8_t * in, int size, char * out, int max_len);
...
*/
int BASE64_DECLSPEC b64_to_bin_nopad(const char * in, int size, uint8_t * out, int max_len);
...
*/
int BASE64_DECLSPEC bin_to_b64(const uint8_t * in, int size, char * out, int max_len);

/**
@brief Decode Base64 string to binary data (remove padding if necessary)
*/
int BASE64_DECLSPEC b64_to_bin(const char * in, int size, uint8_t * out, int max_len);
